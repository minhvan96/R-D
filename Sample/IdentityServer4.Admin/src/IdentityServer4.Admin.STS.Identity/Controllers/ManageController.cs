...
using IdentityServer4.Admin.STS.Identity.ViewModels.Manage;

namespace IdentityServer4.Admin.STS.Identity.Controllers
{    
    [Authorize]
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("IdentityServer4.Admin.STS.Identity"),
