...
using SendGrid;
using IdentityServer4.Admin.Shared.Configuration.Email;
using IdentityServer4.Admin.Shared.Email;
using IdentityServer4.Admin.STS.Identity.Configuration;
using IdentityServer4.Admin.STS.Identity.Configuration.ApplicationParts;
using IdentityServer4.Admin.STS.Identity.Configuration.Constants;
using IdentityServer4.Admin.STS.Identity.Configuration.Interfaces;
using IdentityServer4.Admin.STS.Identity.Helpers.Localization;
using System.Linq;
using IdentityServer4;
using Microsoft.AspNetCore.Authentication.AzureAD.UI;
using Microsoft.AspNetCore.Authentication.OAuth;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using IdentityServer4.Admin.Admin.EntityFramework.MySql.Extensions;
using IdentityServer4.Admin.Admin.EntityFramework.PostgreSQL.Extensions;
using IdentityServer4.Admin.Admin.EntityFramework.Shared.Configuration;
using IdentityServer4.Admin.Admin.EntityFramework.SqlServer.Extensions;
using Skoruba.IdentityServer4.Admin.EntityFramework.Helpers;
using Microsoft.AspNetCore.DataProtection.EntityFrameworkCore;
using Microsoft.AspNetCore.Http;
using Microsoft.IdentityModel.Tokens;
using IdentityServer4.Admin.Shared.Authentication;
using IdentityServer4.Admin.Shared.Configuration.Identity;

namespace IdentityServer4.Admin.STS.Identity.Helpers
{
